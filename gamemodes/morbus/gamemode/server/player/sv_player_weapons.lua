...
function GM:PlayerCanPickupWeapon( ply, wep )
    ...
    if ply:IsSwarm() and wep:GetClass() ~= "weapon_mor_swarm" then
        return false
    elseif not ply:IsSwarm() and wep:GetClass() == "weapon_mor_crowbar" then
        return true
    elseif IsValid( awep ) and awep:GetClass() == "weapon_mor_brood" then
        return false
    elseif not ply:IsSwarm() and wep:GetClass() == "weapon_glowstick_special" then
        return true
    elseif wep:GetClass() == "weapon_mor_swarm" and not ply:IsSwarm() then
        return false
    elseif wep:GetClass() == "weapon_mor_brood" and not ply:IsBrood() then
        return false
