...
sound.Add({
    ...
    channel = CHAN_STATIC,
    volume = 1.0,
    sound = "morbus/pooping.wav"
})

Sounds.Mission = { Sound("need.sleeping"), Sound("need.eating"), Sound("need.shower"), Sound("need.peeing"), Sound(
"need.pooping") }
--1= sleep 2= eat 3= shower 4=pee 5=hidden pee
...
for k, v in pairs(cpain) do
    ...
    table.insert(Sounds.Cyborg.Pain, Sound("cyborg_pain" .. k))
end
...
for k, v in pairs(ckalien) do
    sound.Add({
        name = "cyborg_kill_alien." .. k,
        channel = CHAN_USER_BASE + 2,
        volume = 0.7,
        sound = v
    })
    table.insert(Sounds.Cyborg.KillAlien, Sound("cyborg_kill_alien." .. k))
end
...
for k, v in pairs(dcyborg) do
    ...
    table.insert(Sounds.Cyborg.Death, Sound("cyborg_death." .. k))
end
