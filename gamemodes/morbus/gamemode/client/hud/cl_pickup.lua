...
function GM:HUDWeaponPickedUp(wep)
    ...
    local name      = wep.GetPrintName and wep:GetPrintName() or "MASSIVE NULL ARRAY"
...
function GM:HUDDrawPickupHistory()
    ...
    for k, v in pairs(self.PickupHistory) do
        if v.time < CurTime() then
            ...
            surface.DrawTexturedRectRotated(rx + rw - bordersize / 2, ry + rh - bordersize / 2, bordersize, bordersize,
                180)
            ...
            draw.SimpleText(v.name, v.font, v.x + 2 + v.height + 8, v.y - (v.height / 2) + 2,
