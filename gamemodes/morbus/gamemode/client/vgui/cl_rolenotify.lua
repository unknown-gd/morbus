...
ROLEHELP[ROLE_CYBORG].Title = "You are a Cyborg"
ROLEHELP[ROLE_CYBORG].Bullets = {"Exterminate the infestation!", "You are a durable half machine - half human construct.", "You are to co-exist with humans!", "Normal hazards don't affect you."}
