...
function PANEL:Init()
    ...
    self.Tab[ 1 ]:OpenURL( "https://steamcommunity.com/sharedfiles/filedetails/?id=1949581722" )
    self.Tab[ 1 ].URL = "https://steamcommunity.com/sharedfiles/filedetails/?id=1949581722"

    self.Tab[ 2 ] = vgui.Create( "HTML", self )
    self.Tab[ 2 ]:SetPos( 4, 34 )
    self.Tab[ 2 ]:SetSize( 850 - 8, 750 - 38 )
    self.Tab[ 2 ]:OpenURL( "https://steamcommunity.com/sharedfiles/filedetails/?id=1949570425" )
    self.Tab[ 2 ]:SetVisible( false )
    self.Tab[ 2 ].URL = "https://steamcommunity.com/sharedfiles/filedetails/?id=1949570425"
...
function OPEN_HELPMENU()
    if not RULE_OBJ then
        ...
        RULE_OBJ.Tab[ 1 ]:OpenURL( "https://steamcommunity.com/sharedfiles/filedetails/?id=1949581722" )
    else
        RULE_OBJ:Remove()
        RULE_OBJ = vgui.Create( "RuleMenu" )
        RULE_OBJ.Tab[ 1 ]:OpenURL( "https://steamcommunity.com/sharedfiles/filedetails/?id=1949581722" )
