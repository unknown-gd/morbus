...
function PANEL:Init()
    ...
    self.HB.OnMousePressed = function()
        ...
        self.Tab[ 1 ]:OpenURL( "https://steamcommunity.com/sharedfiles/filedetails/?id=701942836" )
    end
    ...
    self.Tab[ 2 ].Slide = 1
    self.Tab[ 2 ]:OpenURL( "https://steamcommunity.com/sharedfiles/filedetails/?id=1949550464" )
