...
CreateClientConVar( "morbus_low_info", "1", true )
...
function CreateSettingsMenu()
    ...
    local s1f = vgui.Create( "DCheckBoxLabel", pnl )
    s1f:SetPos( 4, 130 )
    s1f:SetText( "Less Weapon Information" )
    s1f:SetConVar( "morbus_low_info" )
    s1f:SetValue( GetConVar( "morbus_low_info" ):GetBool() )
    s1f:SizeToContents()
