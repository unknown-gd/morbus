...
function PANEL:UpdatePlayerData()
    ...
    self.cols[ 1 ]:SetTextColor( ColorForPlayer( ply ) )

    if self.cols[ 2 ] then
        self.cols[ 2 ]:SetText( math.Round( ply:GetBaseSanity() ) )
        self.cols[ 2 ]:SetTextColor( ColorForPlayer( ply ) )
    end
    ...
    self.name:SetTextColor( ColorForPlayer( ply ) )
