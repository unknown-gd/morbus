...
function ENT:CreateLight( col, bright, size, len )
	if SERVER then
		...
		self.FlashlightEnt:SetPos( self.Owner:GetShootPos() + self.Owner:EyeAngles():Forward()*15) 
		self.FlashlightEnt:SetAngles(  self.Owner:GetAngles() )
		...
		self.Owner:SetNWEntity( 'Flashlight', self.FlashlightEnt )
