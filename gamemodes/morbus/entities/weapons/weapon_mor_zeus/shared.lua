...
SWEP.VElements = {
    [ "a" ] = { type = "Model", model = "models/mass_effect_3/weapons/heavy_weapons/m-622 avalanche.mdl", bone = "bone_body", rel = "", pos = Vector( 1.557, -2.597, -1.558 ), angle = Angle( 0, 180, 0 ), size = Vector( 1, 1, 1 ), color = Color( 255, 255, 255, 255 ), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
    [ "a" ] = { type = "Model", model = "models/mass_effect_3/weapons/heavy_weapons/m-622 avalanche.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector( 4.675, 1.2, -2.597 ), angle = Angle( 180, 90, 3.506 ), size = Vector( 1, 1, 1 ), color = Color( 255, 255, 255, 255 ), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
