...
SWEP.VElements              = {
    [ "a" ] = { type = "Model", model = "models/mass_effect_3/weapons/assault_rifles/m-55 argus.mdl", bone = "bone_body", rel = "", pos = Vector( 0, -2.597, 0.699 ), angle = Angle( 0, 180, 0 ), size = Vector( 1, 1, 1 ), color = Color( 255, 255, 255, 255 ), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements              = {
    [ "a" ] = { type = "Model", model = "models/mass_effect_3/weapons/assault_rifles/m-55 argus.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector( 8.831, 1.2, -3.636 ), angle = Angle( 180, 90, 0 ), size = Vector( 1, 1, 1 ), color = Color( 255, 255, 255, 255 ), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:ShootBullet( damage, recoil, num_bullets, aimcone )
    ...
    if CLIENT and not self.Owner:IsNPC() then
