...
if GetConVar( "M9KGasEffect" ) == nil then
    CreateConVar( "M9KGasEffect", "0", { FCVAR_ARCHIVE }, "Use gas effect when shooting? 1 for true, 0 for false" )
end
    ...
    if SERVER and self.Weapon ~= nil then
        ...
        timer.Simple( waitdammit + .1,
            function()
                ...
                if not self.Owner.KeyDown then return end
...
function SWEP:Deploy()
    ...
    if not self.Owner:IsNPC() then self.ResetSights = CurTime() + self.Owner:GetViewModel():SequenceDuration() end
    ...
    function SWEP:ViewModelDrawn()
        ...
        for _, name in ipairs( self.vRenderOrder ) do
            ...
            if not v.hide and v.bone then
                ...
                if pos and (v.type == "Model" and IsValid( model )) then
