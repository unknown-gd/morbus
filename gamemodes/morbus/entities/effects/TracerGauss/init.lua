...
function EFFECT:Render()
    ...
    -- Colored sprites
    render.DrawSprite( self.StartPos, self.Width * 2, self.Width * 1, 255, 185, 185, 255 )
    render.DrawSprite( self.EndPos, self.Width * 2, self.Width * 1, 255, 185, 185, 255 )
end
